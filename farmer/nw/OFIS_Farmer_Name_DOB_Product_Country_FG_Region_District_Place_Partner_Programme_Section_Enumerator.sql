    ...
    f.farmer_name IN (SELECT 
        ...
        WHERE
            TRIM(fm.farmer_name) != ''
                AND fm.app_id = 1
                AND fg.app_id = 1
        GROUP BY fm.farmer_name , fm.dob, fg.product_id, fm.country_id, fm.farmer_group_id, fm.region_id, fm.district_id, fm.place_id, fg.partner_id, fg.programme_id, fm.section_id, fm.enumerator_id
